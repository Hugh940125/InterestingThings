...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private final BaseAnimationListener mReturnToStartPositionListener = new BaseAnimationListener() {
        @Override
    ...
    private final BaseAnimationListener mReturnToHeaderPositionListener = new BaseAnimationListener() {
        @Override
        public void onAnimationEnd(Animation animation) {
            // Once the target content has returned to its start position, reset
            // the target offset to 0
    ...
    public interface OnRefreshListener {
        ...
        public void onRefresh() throws InterruptedException, ExecutionException;
    }
